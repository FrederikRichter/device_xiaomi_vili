...
git clone https://github.com/AOSP-for-vili/device_xiaomi_sm8350-common.git -b lineage-22.2 device/xiaomi/sm8350-common
...
git clone https://github.com/AOSP-for-vili/vendor_xiaomi_camera.git -b 15-qpr2 vendor/xiaomi/camera
